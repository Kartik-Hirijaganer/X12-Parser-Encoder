    ...
    <div className="min-h-screen bg-[var(--color-surface-wash)] text-[var(--color-text-primary)]">
      <header className="sticky top-0 z-20 border-b border-[var(--color-border-default)] bg-[var(--color-surface-primary)]/95 backdrop-blur">
        <div className="mx-auto flex max-w-[1200px] items-center justify-between gap-4 px-6 py-4 lg:px-10">
          <div>
            <NavLink className="text-[18px] font-semibold text-[var(--color-text-primary)]" to="/">
      ...
      <main className="mx-auto flex max-w-[1200px] flex-col gap-6 px-6 py-8 lg:px-10 lg:py-10">
        <div className="space-y-4">
          <div>
            ...
            {subtitle ? (
              <p className="mt-2 max-w-3xl text-[18px] leading-8 text-[var(--color-text-secondary)]">
                {subtitle}
              </p>
            ) : null}
          </div>
      ...
      <footer className="border-t border-[var(--color-border-default)] bg-[var(--color-surface-primary)]">
        <div className="mx-auto flex max-w-[1200px] flex-col gap-2 px-6 py-4 text-[12px] text-[var(--color-text-tertiary)] sm:flex-row sm:items-center sm:justify-between lg:px-10">
