...
variable "enable_snapstart" {
  description = "Enable Lambda SnapStart. Staging defaults off unless explicitly testing cold-start behavior."
  type        = bool
  default     = false
}
...
variable "enable_waf" {
  description = "Enable the CloudFront WAF module. Staging defaults off unless explicitly testing WAF."
  type        = bool
  default     = false
}
